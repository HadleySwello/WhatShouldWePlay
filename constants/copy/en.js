...
export default {
  ...
  setup: {
    ...
    complexityHelper: 'How hard do you want to think?',
    ...
    noMatchesTitle: 'Nothing on the shelf fits.',
    noMatchesBody: "Try widening the filters—we'll find something.",
    ctaViewGames: 'View {{count}} games',
    ctaNoMatches: 'No matches',
    vibeHeader: 'Vibe: {{name}}',
    vibeHeaderModified: 'Vibe: {{name}} (modified)',
    customFilters: 'Custom vibes',
  ...
  rankings: {
    ...
    ctaChooseGame: 'Find the right game',
