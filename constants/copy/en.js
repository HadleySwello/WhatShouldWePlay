...
export default {
  ...
  connectBGG: {
    ...
    header: 'Connect your\nBoardGameGeek\nCollection',
    body: 'To begin the ritual, we will import your BGG Collection and transform it into "Your Shelf"—a private, focused space for tonight\'s decision. Your Shelf is where the magic happens.',
    placeholder: 'BoardGameGeek Username',
    help: 'Why do we need this?',
    loading: 'Consulting the vaults…',
    findAccount:
      'Find your username at BoardGameGeek.com. Accounts are free, open to all, and the pulse of the hobby.',
  ...
  settings: {
    ...
    reduceMovement: 'Reduce Movement',
    reduceMovementDescription: 'Minimizes animations and screen transitions.',
    account: 'Account',
    changeUsername: 'Connect a different shelf',
    deleteMyAccount: 'Reset application data',
  },
  modals: {
    rituals: {
